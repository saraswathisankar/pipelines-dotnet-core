...
| Build image and push to Azure Container Registry (YAML) | [![Build status](https://dev.azure.com/pipelines-docs/docs/_apis/build/status/dotnetcore/dotnetcore-acr-yaml)](https://dev.azure.com/pipelines-docs/docs/_build/latest?definitionId=6) | [![Build Status](https://dev.azure.com/SaraswathiSankarkumar0162/TestProject/_apis/build/status/saraswathisankar.pipelines-dotnet-core?branchName=master)](https://dev.azure.com/SaraswathiSankarkumar0162/TestProject/_build/latest?definitionId=1&branchName=master)
